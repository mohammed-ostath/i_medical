    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column gap-3 account-form mx-auto mt-5">
                <form class="form" method="POST" action="{{ route('auth.register_data') }}">
                    @csrf
                    <div class="form-items">
                        ...
                        <div class="mb-3">
                            <label class="form-label required-label" for="phone">{{ __('Phone') }}</label>
                            <input type="tel" class="form-control" name="phone" id="phone" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required-label" for="email">{{ __('Email Address') }}</label>
